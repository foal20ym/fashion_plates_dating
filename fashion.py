...
def get_input_shape(model_name, include_top):
    if model_name == "NASNetMobile":
        return (331, 331, 3) if include_top else (224, 224, 3)
...
def build_model(config, num_classes=None, input_shape=(224, 224, 3)):
    ...
    base_model = None
    if model_name == "NASNetMobile":
        base_model = NASNetMobile(include_top=config['model']['include_top'], weights="imagenet", input_shape=input_shape, pooling="avg")
    elif model_name == "ResNet101":
        base_model = ResNet101(include_top=config['model']['include_top'], weights="imagenet", input_shape=input_shape, pooling="avg")
    elif model_name == "InceptionV3":
        base_model = InceptionV3(include_top=config['model']['include_top'], weights="imagenet", input_shape=input_shape, pooling="avg")
